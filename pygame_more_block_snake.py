...
class snake():
    ...
    def design_food1(self):
        pygame.draw.rect(self.game_window, self.purple, [self.food_x1, self.food_y1, self.snake_block, self.snake_block])

    def design_food2(self):
        pygame.draw.rect(self.game_window, self.carrot, [self.food_x2, self.food_y2, self.snake_block, self.snake_block])
